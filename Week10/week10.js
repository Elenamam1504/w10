...
function showMessage(guestName = 'Гость') {
  let message = 'Привет, ' + guestName;
  console.log(message);
}
...
// let calculateSquare = squaredNumber(num) => {
...
let result = calculateYearsSinceLastOlympics(2023, 2021);

console.log('С момента летней олимпиады в Токио прошло ' + result + ' года');
...
let result2 = calculateAge(2023, 1985);

console.log('Тебе сейчас ' + result2 + ' лет');
//Задание 17
...
let yourYearOfBirth = 1985;

function countHowOld(nowYear, yourYearOfBirth) {
  return nowYear - yourYearOfBirth;
}
let result3 = countHowOld(2023, 1985);

console.log('Твой возраст ' + result3 + ' лет');
...
function countsquare(number, numberDegree) {
  return number ** numberDegree;
}
let result4 = countsquare(2, 4);
